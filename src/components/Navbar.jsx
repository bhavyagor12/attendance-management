  ...
  return (
    <div className="shadow-md w-full flex">
      ...
      text-gray-800"
        ...
        <ul
          className={`justify-center md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-white md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${
